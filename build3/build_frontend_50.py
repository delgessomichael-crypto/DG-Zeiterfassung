...
js=base_js.read_text();css=base_css.read_text();feat='\n'.join((R/'src'/name).read_text() for name in ['features_5_0.js','features_5_0_1.js','features_5_0_2.js','features_5_0_3.js','features_5_0_4.js','features_5_0_5.js','features_5_1.js']);feat_css=(R/'src/features_5_0.css').read_text()+'\n'+(R/'src/features_5_0_1.css').read_text()
...
for old in ("version:'3.9'","version:'5.0'","version:'5.0.1'","version:'5.0.2'","version:'5.0.3'","version:'5.0.4'","version:'5.0.5'","version:'5.1.0'"):
    js=js.replace(old,"version:'5.1'")
for old in ("DG_APP_VERSION='3.9'","DG_APP_VERSION='5.0'","DG_APP_VERSION='5.0.1'","DG_APP_VERSION='5.0.2'","DG_APP_VERSION='5.0.3'","DG_APP_VERSION='5.0.4'","DG_APP_VERSION='5.0.5'","DG_APP_VERSION='5.1.0'"):
    js=js.replace(old,"DG_APP_VERSION='5.1'")
for old in ("clientVersion:'3.9'","clientVersion:'5.0'","clientVersion:'5.0.1'","clientVersion:'5.0.2'","clientVersion:'5.0.3'","clientVersion:'5.0.4'","clientVersion:'5.0.5'","clientVersion:'5.1.0'"):
    js=js.replace(old,"clientVersion:'5.1'")
for old in ('App 3.9','App 5.0.1','App 5.0.2','App 5.0.3','App 5.0.4','App 5.0.5'):
    js=js.replace(old,'App 5.1')
js=js.replace('Google-GS 3.0','Google-GS 5.1').replace('Google-GS 5.0.1','Google-GS 5.1').replace('Google-GS 5.0.2','Google-GS 5.1').replace('Backend 3.0','Backend 5.1').replace('Backend 5.0.2','Backend 5.1')
js=js.replace('/^3\\./','/^(?:3\\.|5\\.)/')
css=css+'\n'+feat_css+'\n'
(O/'app-5.0.js').write_text(js);(O/'app-5.0.css').write_text(css)
html=BeautifulSoup(base_html.read_text(),'html.parser');html.title.string='DG Zeiterfassung 5.1';login=html.select_one('.login-card .center.muted.small');hero=html.select_one('.hero .head-row strong')
if login:login.string='Version 5.1'
if hero:hero.string='Zeiterfassung - 5.1'
