...
# Replace obsolete function bodies instead of layering duplicate implementations into the final app.
replace_names={'updatePhotoStatus','startCamera','captureCameraPhoto','addPhotos','refreshWeek'}
...
# Append only the genuinely new 3.5 logic.
