...
const CACHE='dg-zeiterfassung-10.0-full-audit-20260924-1930';
const STATIC=[
  './index.html',
  './app-5.0.css?v=20260924-1130-inspection-quick1',
  './core-9.0-final.js?v=20260924-1930-full-audit1',
  ...
  './ui-9.0-final.js?v=20260924-1900-finance-import-fix',
  './dg_icon_192.png',
  './dg_icon_512.png',
  './manifest.json'
];
