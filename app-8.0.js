...
/* DG Zeiterfassung 8.0 - strikte, einheitliche Backend-Anbindung */
(function(){
'use strict';
...
/* DG Zeiterfassung 8.0 - Monteur-Eingabe: Ja/Nein-Tasten und Sprache-zu-Text */
(function(){
'use strict';
...
/* DG Zeiterfassung 8.0 - UI-Farben, Kalender-Refresh und zentraler Versionsstempel */
(function(){
'use strict';
const V='8.0';
...
/* DG Zeiterfassung 8.0 - Eigene Reminder mit Sprache, Bildern und Dateien */
(function(){
'use strict';
const V='8.0';
...
/* DG Zeiterfassung 8.0 - finaler Produktions-Hardening-Layer */
(function(){
'use strict';
const V='8.0';
const BACKEND_URL='https://script.google.com/macros/s/AKfycby2L3SMgh2RoGWsNRUp6o11g4iyZ8bgkSIGaAZPnBXCkJTkDDGF9aydn9vVKMB7kXsO/exec';
...
/* DG Zeiterfassung 8.0 - Interne Notizen fuer eigene Reminder */
(function(){
'use strict';
...
async function loadAvailability733(){
  ...
  try{
    ...
    availability733=[];
    const s=$733('dg62Status');if(s&&/Kalender synchronisiert/i.test(s.textContent||''))s.textContent='✓ Kalender synchronisiert. Abwesenheitsmarkierung benötigt Google-GS 8.0.';
  }
}
...
/* DG Zeiterfassung 8.0 - bereinigte aktuelle Laufzeit ohne 7.3.x-Overlaykette */
(function(){
'use strict';
const V='8.0';
const $=id=>document.getElementById(id);
...
function boot742(){
  ...
  try{
    ...
    console.error('DG 8.0 Startfehler',e);
...
async function raw742(payload){
  ...
  try{
    const r=await fetch(URL742,{method:'POST',headers:{'Content-Type':'text/plain;charset=utf-8'},body:JSON.stringify(Object.assign({},payload,{clientVersion:'8.0'})),signal:ctl.signal});
    if(!r.ok)throw new Error('HTTP '+r.status);
...
function installOffice742(){
  ...
  try{
    ...
    console.error('DG Büroaufbau 8.0 fehlgeschlagen',e);
