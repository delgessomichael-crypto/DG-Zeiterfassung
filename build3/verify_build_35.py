...
assert 'Version 3.5.2' in h.get_text() and 'Zeiterfassung - 3.5.2' in h.get_text()
...
assert 'AQON PURE ANFRAGEN' in js and "action:'syncCustomerInquiries'" in js and 'aqonSyncAt' in js
...
assert 'dg-zeiterfassung-3-5-2-' in sw and 'withPatches' not in sw
print('PASS DG 3.5.2: chef inspection visible hook, correct offer count, AQON auto-sync, unlimited photos, weekend/holiday rules.')