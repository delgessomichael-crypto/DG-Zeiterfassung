...
let lastSync10=0;async function sync20(){if(document.hidden||!navigator.onLine||Date.now()-lastSync10<1190000)return;lastSync10=Date.now();if(typeof canAccessBoss==='function'&&canAccessBoss()){try{await api(bossPayload10({action:'syncCustomerInquiries'}));}catch(_e){}try{if(typeof d3Inquiries==='function')await d3Inquiries();}catch(_e){}try{if(typeof dg62Load==='function')await dg62Load();}catch(_e){}}else{try{if(typeof loadCalendarEvents==='function')await loadCalendarEvents(true);}catch(_e){}}}
