...
const CACHE='dg-zeiterfassung-10.0-final-railway10-20260923-2210';
const STATIC=[
  './index.html',
  './app-5.0.css?v=20260918-800-prod1',
  './core-9.0-final.js?v=20260923-2210-final-railway10',
  ...
  './railway-cutover-10.0.js?v=20260923-railway-cutover1',
  './dg_icon_192.png',
  './dg_icon_512.png',
  './manifest.json'
];
