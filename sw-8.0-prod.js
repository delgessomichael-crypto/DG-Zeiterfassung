...
const CACHE='dg-zeiterfassung-8.0-prod-20260918-1';
const STATIC=[
  './app-5.0.css?v=20260918-800-prod1',
  './app-8.0.js?v=20260918-800-prod1',
  './payroll-hotfix-8.0.js?v=20260918-800-prod1',
  './ui-hotfix-8.0.js?v=20260918-800-prod1',
  './dg_icon_192.png',
  './dg_icon_512.png',
  './manifest.json'
];
