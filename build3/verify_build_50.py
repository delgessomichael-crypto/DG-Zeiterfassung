...
assert 'DG Zeiterfassung 5.0.2' in html
assert 'Version 5.0.2' in html
assert 'Zeiterfassung - 5.0.2' in html
assert "version:'5.0.2'" in js
assert "DG_APP_VERSION='5.0.2'" in js
assert "clientVersion:'5.0.2'" in js
...
assert 'dg-zeiterfassung-5-0-2-' in sw
assert 'DG Zeiterfassung 5.0.2' in manifest and 'DG 5.0.2' in manifest
...
print('DG 5.0.2 verification OK')
