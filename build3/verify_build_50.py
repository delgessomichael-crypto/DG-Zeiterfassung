...
assert 'DG Zeiterfassung 5.0.3' in html
assert 'Version 5.0.3' in html
assert 'Zeiterfassung - 5.0.3' in html
assert "version:'5.0.3'" in js
assert "DG_APP_VERSION='5.0.3'" in js
assert "clientVersion:'5.0.3'" in js
...
assert 'dg-zeiterfassung-5-0-3-' in sw
assert 'DG Zeiterfassung 5.0.3' in manifest and 'DG 5.0.3' in manifest
...
print('DG 5.0.3 verification OK')
