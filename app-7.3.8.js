/* DG 7.3.8 FINAL - einheitlicher sichtbarer Versionsstand */
(function(){
'use strict';
const V='7.3.8';
function stamp(){
...
/* DG Zeiterfassung 7.3.8 - konsolidierter Runtime-Layer */
(function(){
'use strict';
const V='7.3.8',VIEW='dg60_view',STATE='dg60_office_state',BACK='dg60_backend',BACK_TTL=1800000,OFFER_TTL=30000;
...
/* Regie: keine N+1-getObjectReports-Nachladung mehr. GS 7.3.8 liefert die Historie komplett. */
...
/* DG Zeiterfassung 7.3.8 - strikte, einheitliche Backend-Anbindung */
(function(){
'use strict';
const V='7.3.8',PREVIOUS=['7.3.7','7.3.6','7.3.5','7.3.4','7.3.3','7.3.2','7.3.1','7.3','7.2.1','7.2','7.1','7.0'],KEY='dg70_backend',TTL=5*60*1000;
...
/* DG Zeiterfassung 7.3.8 - Monteur-Eingabe: Ja/Nein-Tasten und Sprache-zu-Text */
(function(){
'use strict';
...
/* DG Zeiterfassung 7.3.8 - UI-Farben, Kalender-Refresh und zentraler Versionsstempel */
(function(){
'use strict';
const V='7.3.8';
...
/* DG Zeiterfassung 7.3.8 - Eigene Reminder mit Sprache, Bildern und Dateien */
(function(){
'use strict';
const V='7.3.8';
...
/* DG Zeiterfassung 7.3.8 - finaler Produktions-Hardening-Layer */
(function(){
'use strict';
const V='7.3.8';
const BACKEND_URL='https://script.google.com/macros/s/AKfycby2L3SMgh2RoGWsNRUp6o11g4iyZ8bgkSIGaAZPnBXCkJTkDDGF9aydn9vVKMB7kXsO/exec';
...
/* DG Zeiterfassung 7.3.8 - Interne Notizen fuer eigene Reminder */
(function(){
'use strict';
...
/* ===== CONSOLIDATED SOURCE: app-7.3.1-fixes.js ===== */
...
/* ===== CONSOLIDATED SOURCE: app-7.3.2-auto-rollover.js ===== */
...
/* ===== CONSOLIDATED SOURCE: app-7.3.3-planner-availability.js ===== */
...
/* ===== CONSOLIDATED SOURCE: app-7.3.4-absence-payroll.js ===== */
...
/* ===== CONSOLIDATED SOURCE: app-7.3.5-health-note.js ===== */
...
/* ===== CONSOLIDATED SOURCE: app-7.3.8-final-fixes.js ===== */
...
function observe738(){
  ...
  observer738.observe(root,{childList:true,subtree:true});
}
function stamp738(){
  try{
