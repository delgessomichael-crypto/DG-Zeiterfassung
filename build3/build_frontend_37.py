...
js=js.replace("version:'3.7.1'","version:'3.7.2'",1).replace("version:'3.7'","version:'3.7.2'",1).replace("DG_APP_VERSION='3.7.1'","DG_APP_VERSION='3.7.2'",1).replace("DG_APP_VERSION='3.7'","DG_APP_VERSION='3.7.2'",1).replace("clientVersion:'3.7.1'","clientVersion:'3.7.2'",1).replace("clientVersion:'3.7'","clientVersion:'3.7.2'",1).replace('App 3.7.1','App 3.7.2').replace('App 3.7','App 3.7.2')
css=css+'\n'+feat_css+'\n'
