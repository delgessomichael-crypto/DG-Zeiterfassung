...
assert 'DG Zeiterfassung 5.1' in html
assert 'Version 5.1' in html
assert 'Zeiterfassung - 5.1' in html
assert "version:'5.1'" in js
assert "DG_APP_VERSION='5.1'" in js
assert "clientVersion:'5.1'" in js
assert 'Google-GS 5.1' in js and 'Google-GS 3.0' not in js
...
assert 'dg-zeiterfassung-5-1-' in sw
assert 'DG Zeiterfassung 5.1' in manifest and 'DG 5.1' in manifest
