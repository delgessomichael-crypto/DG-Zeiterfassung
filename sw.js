const CACHE_NAME = 'dg-zeiterfassung-v50';
const APP_SHELL = ['./','./index.html','./v45-patch.js','./v48-patch.js','./v49-patch.js','./v50-patch.js','./manifest.json','./dg_icon_192.png','./dg_icon_512.png'];
...
async function withV50Patches(response){
  ...
  html=html.replace(/<title>DG Zeiterfassung v\d+<\/title>/,'<title>DG Zeiterfassung v50</title>');
