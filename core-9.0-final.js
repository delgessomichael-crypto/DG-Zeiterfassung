...
let lastSync10=0;async function sync20(){if(document.hidden||!navigator.onLine||Date.now()-lastSync10<1190000)return;lastSync10=Date.now();try{if(typeof canAccessBoss==='function'&&canAccessBoss()){await api(bossPayload10({action:'syncCustomerInquiries'}));if(typeof d3Inquiries==='function')await d3Inquiries();if(typeof dg62Load==='function')await dg62Load();}else if(typeof loadCalendarEvents==='function')await loadCalendarEvents(true);}catch(_e){}}
