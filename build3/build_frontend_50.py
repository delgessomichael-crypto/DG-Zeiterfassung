...
versions=['3.9','5.0','5.0.1','5.0.2','5.0.3','5.0.4','5.0.5','5.1','5.1.0','5.1.1','5.1.2','5.2.0','5.2.1','5.2.2','5.2.3']
for old in versions: js=js.replace("version:'"+old+"'","version:'5.2.3'")
for old in versions: js=js.replace("DG_APP_VERSION='"+old+"'","DG_APP_VERSION='5.2.3'")
for old in versions: js=js.replace("clientVersion:'"+old+"'","clientVersion:'5.2.3'")
for old in ['App 3.9','App 5.0.1','App 5.0.2','App 5.0.3','App 5.0.4','App 5.0.5','App 5.1','App 5.1.1','App 5.1.2','App 5.2.0','App 5.2.1','App 5.2.2']: js=js.replace(old,'App 5.2.3')
...
html=BeautifulSoup(base_html.read_text(),'html.parser');html.title.string='DG Zeiterfassung 5.2.3';login=html.select_one('.login-card .center.muted.small');hero=html.select_one('.hero .head-row strong')
if login: login.string='Version 5.2.3'
if hero: hero.string='Zeiterfassung - 5.2.3'
