const CACHE_NAME = 'dg-zeiterfassung-v56-1';
const APP_SHELL = ['./','./index.html','./v45-patch.js','./v48-patch.js','./v49-patch.js','./v50-patch.js','./v51-patch.js','./v53-finish.js','./v54-patch.js','./v55-patch.js','./v56-patch.js','./manifest.json','./dg_icon_192.png','./dg_icon_512.png'];
...
async function withV56Patches(response){
  ...
  [['v45-patch.js','45'],['v48-patch.js','48'],['v49-patch.js','49'],['v50-patch.js','50'],['v51-patch.js','51'],['v53-finish.js','53.1'],['v54-patch.js','54.1'],['v55-patch.js','55.1'],['v56-patch.js','56.1']].forEach(x=>{if(!html.includes(x[0]))html=html.replace('</body>','<script src="./'+x[0]+'?v='+x[1]+'"></script>\n</body>')});
  html=html.replace(/<title>DG Zeiterfassung v\d+<\/title>/,'<title>DG Zeiterfassung v56</title>');
