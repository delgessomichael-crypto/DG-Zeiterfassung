...
.login-card .center.muted.small::after{content:'Version ${LABEL}';font-size:13px!important}
.hero .head-row strong{font-size:0!important}
.hero .head-row strong::after{content:'Zeiterfassung · ${LABEL}';font-size:16px!important}
`;
