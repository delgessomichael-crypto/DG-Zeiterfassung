/* DG 7.3.2 FINAL - einheitlicher sichtbarer Versionsstand */
(function(){
'use strict';
const V='7.3.2';
function stamp(){
...
/* DG Zeiterfassung 7.3.2 - konsolidierter Runtime-Layer */
(function(){
'use strict';
const V='7.3.2',VIEW='dg60_view',STATE='dg60_office_state',BACK='dg60_backend',BACK_TTL=1800000,OFFER_TTL=30000;
...
/* Regie: keine N+1-getObjectReports-Nachladung mehr. GS 7.3.2 liefert die Historie komplett. */
...
/* DG Zeiterfassung 7.3.2 - strikte, einheitliche Backend-Anbindung */
(function(){
'use strict';
const V='7.3.2',PREVIOUS=['7.3.2','7.3.1','7.3','7.2.1','7.2','7.1','7.0'],KEY='dg70_backend',TTL=5*60*1000;
...
/* DG Zeiterfassung 7.3.2 - Monteur-Eingabe: Ja/Nein-Tasten und Sprache-zu-Text */
(function(){
'use strict';
...
/* DG Zeiterfassung 7.3.2 - UI-Farben, Kalender-Refresh und zentraler Versionsstempel */
(function(){
'use strict';
const V='7.3.2';
...
/* DG Zeiterfassung 7.3.2 - Eigene Reminder mit Sprache, Bildern und Dateien */
(function(){
'use strict';
const V='7.3.2';
...
/* DG Zeiterfassung 7.3.2 - finaler Produktions-Hardening-Layer */
(function(){
'use strict';
const V='7.3.2';
const BACKEND_URL='https://script.google.com/macros/s/AKfycby2L3SMgh2RoGWsNRUp6o11g4iyZ8bgkSIGaAZPnBXCkJTkDDGF9aydn9vVKMB7kXsO/exec';
...
/* DG Zeiterfassung 7.3.2 - Interne Notizen fuer eigene Reminder */
(function(){
'use strict';
